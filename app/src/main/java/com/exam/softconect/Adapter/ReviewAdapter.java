...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.ProductViewHolder> {
    ...
    ResumeTestActivity resumeTestActivity;

    public ReviewAdapter(Context mctx, List<TestPanelHelper> reviewList, Dialog dialog_review, ResumeTestActivity resumeTestActivity) {
        this.mctx = mctx;
        this.reviewList = reviewList;
        this.dialog_review = dialog_review;
        this.resumeTestActivity = resumeTestActivity;
    }
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            resumeTestActivity.setReview_Questions( str_student_ans, Integer.parseInt(str_ques_order));
